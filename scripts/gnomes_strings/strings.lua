...
local function GetDropChance(tuning_name, mod)
	return tostring(TUNING.GNOME_DROP_RATES[tuning_name]) * (mod or 100)
end

--	UI

-- Scrapbook strings : % Chance + How to get Gnomes

--[[001]] STRINGS.SCRAPBOOK.SPECIALINFO.ICE_GNOME			= GetDropChance("ICE_GNOME").."% chance to drop from killing Deerclops."
--[[002]] STRINGS.SCRAPBOOK.SPECIALINFO.ICE_GNOMETTE		= GetDropChance("ICE_GNOMETTE").."% chance to drop from killing Deerclops."
--[[003]] STRINGS.SCRAPBOOK.SPECIALINFO.EGG_GNOME			= GetDropChance("EGG_GNOME").."% chance to drop from killing Moose/Goose."
--[[004]] STRINGS.SCRAPBOOK.SPECIALINFO.BEARGER_GNOME		= GetDropChance("BEARGER_GNOME").."% chance to drop from killing Bearger."
--[[005]] STRINGS.SCRAPBOOK.SPECIALINFO.DFLY_GNOME1			= GetDropChance("DFLY_GNOME1").."% chance to drop from killing Dragonfly."
--[[006]] STRINGS.SCRAPBOOK.SPECIALINFO.DFLY_GNOME2			= GetDropChance("DFLY_GNOME2").."% chance to drop from killing enraged Dragonfly."
--[[007]] STRINGS.SCRAPBOOK.SPECIALINFO.BEEQUEEN_GNOME		= GetDropChance("BEEQUEEN_GNOME").."% chance to drop from killing Bee Queen."
--[[008]] STRINGS.SCRAPBOOK.SPECIALINFO.TOADSTOOL_GNOME1	= GetDropChance("TOADSTOOL_GNOME1").."% chance to drop from killing Toadstool."
--[[009]] STRINGS.SCRAPBOOK.SPECIALINFO.TOADSTOOL_GNOME2	= GetDropChance("TOADSTOOL_GNOME2").."% chance to drop from killing Misery Toadstool."
--[[010]] STRINGS.SCRAPBOOK.SPECIALINFO.BOOT_GNOME			= GetDropChance("BOOT_GNOME").."% chance from trading fish with Frostjaw."

--[[011]] STRINGS.SCRAPBOOK.SPECIALINFO.BERET_GNOME			= GetDropChance("BERET_GNOME").."% chance to drop from killing frogs."

--[[012]] STRINGS.SCRAPBOOK.SPECIALINFO.UPSIDEDOWN_GNOME	= "Can fall from the ceiling during earthquakes."

--[[013]] STRINGS.SCRAPBOOK.SPECIALINFO.DERP_GNOME			= GetDropChance("DERP_GNOME").."% chance to be found in tumbleweeds."
--[[014]] STRINGS.SCRAPBOOK.SPECIALINFO.DERP_GNOMETTE		= GetDropChance("DERP_GNOMETTE").."% chance to be found in tumbleweeds."

--[[015]] STRINGS.SCRAPBOOK.SPECIALINFO.CHEF_GNOME			= GetDropChance("CHEF_GNOME").."% chance to drop when a dish completes in a Crock Pot."

--[[016]] STRINGS.SCRAPBOOK.SPECIALINFO.POTTED_GNOME		= GetDropChance("POTTED_GNOME").."% chance to be found in tumbleweeds."

--[[017]] STRINGS.SCRAPBOOK.SPECIALINFO.GNUDIST_GNOME		= GetDropChance("GNUDIST_GNOME").."% chance to drop from killing Birchnutters."
--[[018]] STRINGS.SCRAPBOOK.SPECIALINFO.BUTTCHEEK_GNOME		= GetDropChance("BUTTCHEEK_GNOME").."% chance when opening wet pouches."

--[[019]] STRINGS.SCRAPBOOK.SPECIALINFO.GNEO_GNOME			= GetDropChance("GNEO_GNOME").."% chance to drop from killing a Tier 3 Shadow Knight."
--[[020]] STRINGS.SCRAPBOOK.SPECIALINFO.GLOOMY_GNOME		= GetDropChance("GLOOMY_GNOME2").."% chance from killing Nightmarebeaks and "..GetDropChance("PIRATE_GNOME").."% chance from killing Terrorbeaks."

--[[021]] STRINGS.SCRAPBOOK.SPECIALINFO.SNURTLE_GNOME		= GetDropChance("SNURTLE_GNOME").."% chance to drop from killing Snurtles."
--[[022]] STRINGS.SCRAPBOOK.SPECIALINFO.PIRATE_GNOME		= GetDropChance("PIRATE_GNOME2").."% chance to drop from killing Prime Mates and "..GetDropChance("PIRATE_GNOME").."% chance from killing Powder Monkeys."

--[[023]] STRINGS.SCRAPBOOK.SPECIALINFO.STPATRICK_GNOME		= GetDropChance("STPATRICK_GNOME").."% chance when smashing an oversized potato."
--[[024]] STRINGS.SCRAPBOOK.SPECIALINFO.STPATRICK_GNOMETTE	= GetDropChance("STPATRICK_GNOMETTE").."% chance when smashing an oversized potato."

--[[025]] STRINGS.SCRAPBOOK.SPECIALINFO.BABY_GNOME			= GetDropChance("BABY_GNOME").."% chance to be left as a gift by a canary."
--[[026]] STRINGS.SCRAPBOOK.SPECIALINFO.BABY_DEVIL_GNOME	= GetDropChance("BABY_DEVIL_GNOME").."% chance to drop from killing Krampus."
--[[027]] STRINGS.SCRAPBOOK.SPECIALINFO.BABY_ANGEL_GNOME	= GetDropChance("BABY_ANGEL_GNOME").."% chance to drop when releasing a Volatile Canary on the surface."

--[[028]] STRINGS.SCRAPBOOK.SPECIALINFO.BABY_KNIFE_GNOME	= GetDropChance("BABY_KNIFE_GNOME").."% chance to drop from a player killing Chester."
--[[029]] STRINGS.SCRAPBOOK.SPECIALINFO.BABY_KNIFE_DARKNESS_GNOME	= GetDropChance("BABY_KNIFE_DARKNESS_GNOME").."% chance to drop from a player killing Shadow Chester."
--[[030]] STRINGS.SCRAPBOOK.SPECIALINFO.BABY_KNIFE_ICE_GNOME		= GetDropChance("BABY_KNIFE_ICE_GNOME").."% chance to drop from a player killing Snow Chester."

--[[031]] STRINGS.SCRAPBOOK.SPECIALINFO.JIMBO_GNOME			= "Drops when scoring "..GetDropChance("JIMBO_GNOME", 1).." or higher when playing with JIMBO."

--[[032]] STRINGS.SCRAPBOOK.SPECIALINFO.POOP_GNOME			= GetDropChance("POOP_GNOME").."% chance for a Werepig to poop it out."

--[[033]] STRINGS.SCRAPBOOK.SPECIALINFO.CATCOON_GNOME		= GetDropChance("CATCOON_GNOME").."% chance to drop from killing Catcoon."
--[[034]] STRINGS.SCRAPBOOK.SPECIALINFO.CATCOON_SILLY_GNOME = GetDropChance("CATCOON_SILLY_GNOME").."% chance to be vomitted up by a tamed Catcoon."

--[[035]] STRINGS.SCRAPBOOK.SPECIALINFO.RAINCOAT_GNOMETTE	= GetDropChance("RAINCOAT_GNOMETTE").."% chance to spawn from a Rainometer at the start of each day, IF it is raining."
--[[036]] STRINGS.SCRAPBOOK.SPECIALINFO.MOD_CHERRYFOREST_GNOMETTE = GetDropChance("MOD_CHERRYFOREST_GNOMETTE").."% chance to drop from giving your critter its favorite food."
--[[037]] STRINGS.SCRAPBOOK.SPECIALINFO.APRILFOOLS_GNOME	= GetDropChance("APRILFOOLS_GNOME").."% chance to drop from killing a Briar Wolf."

--[[037]] STRINGS.SCRAPBOOK.SPECIALINFO.PLUMBER_BROTHER_GNOME1	= GetDropChance("PLUMBER_BROTHER_GNOME1").."% chance to drop from TODO"
--[[037]] STRINGS.SCRAPBOOK.SPECIALINFO.PLUMBER_BROTHER_GNOME2	= GetDropChance("PLUMBER_BROTHER_GNOME2").."% chance to drop from TODO"
...
local PLUMBER_BROTHER_GNOME1_STRINGS = {
	GENERIC = "TODO",
	WAXWELL = "TODO",
	WOLFGANG = "TODO",
	WX78 = "TODO",
...
NAMES.PLUMBER_BROTHER_GNOME1 = "Plumber Brother Gnome"
SetItemsDescribeStrings("PLUMBER_BROTHER_GNOME1", PLUMBER_BROTHER_GNOME1_STRINGS)

--

local PLUMBER_BROTHER_GNOME2_STRINGS = {
	GENERIC = "TODO",
	WAXWELL = "TODO",
	WOLFGANG = "TODO",
	WX78 = "TODO",
...
NAMES.PLUMBER_BROTHER_GNOME2 = "Plumber Brother Other Gnome"
SetItemsDescribeStrings("PLUMBER_BROTHER_GNOME2", PLUMBER_BROTHER_GNOME2_STRINGS)